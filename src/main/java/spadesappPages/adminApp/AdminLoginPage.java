...
public class AdminLoginPage {
    private static  By adminLoginPageTitleDisplay = By.xpath("//div[@class='styles_cardTitle__2jYRE']");
    private static  By emailAddress_labelDisplay = By.xpath("//div[@class='styles_email__1x4q_']");
    private static  By inputEmail = By.xpath("//input[@class='styles_emailInput__1kC6h']");
    private static  By loginButton = By.className("styles_buttonContainer__3fGV0");
    private static  By getEmailId = By.className("otp_emailHighlight__ZxdKw");

    private static By verificationCodeInput1 = By.xpath("//input[contains(@aria-label, 'Digit 1')]");
    private static By verificationCodeInput2 = By.xpath("//input[contains(@aria-label, 'Digit 2')]");
    private static By verificationCodeInput3 = By.xpath("//input[contains(@aria-label, 'Digit 3')]");
    private static By verificationCodeInput4 = By.xpath("//input[contains(@aria-label, 'Digit 4')]");

    private static By transactionPage = By.xpath("//span[text()='Transaction']");
    ...
    public static String getUserEmailId() throws IOException {
       return getTextValue(getEmailId,"email id Text is Displayed");
    }
