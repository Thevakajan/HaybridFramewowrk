...
public class ScreenActions {
    ...
    private static MobileElement getMobileElement(String mobileElement, MobileFindBy mobileFindBy) {
        switch (mobileFindBy) {
            case XPATH:
    ...
    public static void click(String element, MobileFindBy elementType, String elementName) throws IOException {
    ...
    protected void enter(String element, MobileFindBy elementType, String value, String elementName) throws IOException {
     ...
     */
    public void longPress(MobileElement element) throws IOException {
        try {
     ...
     */
    public void scrollToLocation(MobileElement element, int value) throws IOException {
        try {
